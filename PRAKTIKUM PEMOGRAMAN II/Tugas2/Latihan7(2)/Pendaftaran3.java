...
public class Pendaftaran3 extends JFrame {
    ...
    this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ...
        String[] tabunganOptions = {"Tabungan Tahapan", "Tabungan Xpresi", "Tabungan Prioritas", "Simpanan Pelajar"};
        ...
        this.setTitle("Form Pendaftaran Nasabah Bank ABC");
    ...
    public static void main(String[] args) {
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                Pendaftaran3 h = new Pendaftaran3();
                h.setVisible(true);
            }
        });
    }
